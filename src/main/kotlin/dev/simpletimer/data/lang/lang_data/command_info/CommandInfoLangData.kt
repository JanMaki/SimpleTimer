...
data class CommandInfoLangData(
    ...
    val dice: CommandInfo = CommandInfo(),
    ...
    val listShow: CommandInfo = CommandInfo(),
    val listAddTimer: CommandInfo = CommandInfo(),
    val listAddDice: CommandInfo = CommandInfo(),
    ...
    val listSyncOff: CommandInfo = CommandInfo(),
    ...
    val queueAdd: CommandInfo = CommandInfo(),
    ...
    val tts: CommandInfo = CommandInfo(),
    ...
    val mentionType: CommandInfo = CommandInfo(),
    ...
    val timerOPTTiming: CommandInfo = CommandInfo(),
    val timerOPTType: CommandInfo = CommandInfo(),
